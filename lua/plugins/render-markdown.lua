...
return {
  ...
  init = function()
    ...
    local color1_bg = colors["custom_color18"]
    local color2_bg = colors["custom_color19"]
    local color3_bg = colors["custom_color20"]
    local color4_bg = colors["custom_color21"]
    local color5_bg = colors["custom_color22"]
    local color6_bg = colors["custom_color23"]
    local color_fg = colors["custom_color10"]
